...
@OpenAPIDefinition(
		...
		info = @Info(title = "Denuncia Li", version = "1.0.0", description = "REST API para denúncias de crimes em Cabo Verde", contact = @Contact(name = "Elisângela Rosa", email = "symparosa@gmail.com")), servers = {
				...
				@Server(url = "http://104.131.179.103:8080")
		}, tags = {
				...
				@Tag(name = "Notícia", description = "Operações relacionadas à gestão de notícias na API."),
				@Tag(name = "Auditoria", description = "Operações relacionadas à gestão de auditorias na API."),
				@Tag(name = "Reprocessamento", description = "Operações relacionadas à gestão de reprocessamentos na API."),
