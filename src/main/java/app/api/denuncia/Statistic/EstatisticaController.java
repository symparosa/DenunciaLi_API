...
public class EstatisticaController {
    ...
    @Operation(tags = {
            "Estatística Denúncia" }, summary = "Get Estatística Denúncia Por Ano", description = "Lista os dados estatísticos por ano(s).", parameters = {
    ...
    @Operation(tags = {
            "Estatística Denúncia" }, summary = "Get Estatística Denúncia Por Ano e Tipo de Queixa", description = "Lista os dados estatísticos por ano e tipo de queixa.", parameters = {
    ...
    @Operation(tags = {
            "Estatística Denúncia" }, summary = "Get Estatística Denúncia Por Ano e Genero", description = "Lista os dados estatísticos por ano e genero.", parameters = {
                    @Parameter(name = "Ano", description = "O ano que se quer obter os dados") })
